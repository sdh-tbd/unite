...
function CarouselRoot({
  ...
  return (
    ...
    >
      {/* biome-ignore lint/a11y/useSemanticElements: the APG carousel pattern names this region explicitly, and <section> cannot take the div props spread below. */}
      <div
...
function CarouselContent({ className, overflowHidden = true, ...props }: CarouselContentProps) {
...
function CarouselItem({ className, ...props }: ComponentPropsWithRef<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: a slide is a labelled group per the APG carousel pattern, not a <fieldset>.
    <div
      role="group"
...
function Trigger({ className, children, asChild, direction, style, ...props }: TriggerProps) {
...
function CarouselPrevTrigger(props: Omit<TriggerProps, "direction">) {
  return <Trigger {...props} direction="prev" />
}

function CarouselNextTrigger(props: Omit<TriggerProps, "direction">) {
  return <Trigger {...props} direction="next" />
}
