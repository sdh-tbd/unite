        ...
        <>
          ...
          {(label || hint) && (
            <div className={cx("inline-flex flex-col", sizes[size].textWrapper)}>
              ...
              {hint && (
                // biome-ignore lint/a11y/noStaticElementInteractions: the handler adds no interactivity, it stops a click on the hint from toggling the control.
                // biome-ignore lint/a11y/useKeyWithClickEvents: there is no keyboard equivalent of clicking hint text, and the control itself stays keyboard operable.
                <span
...
export function RadioGroup({ children, className, size = "sm", ...props }: RadioGroupProps) {
  return (
