...
import { isReactComponent } from "@unite/ui/utils/is-react-component"
...
export { type CommonProps, SelectContext, type SelectItemType, sizes } from "./select-shared"
            ...
            <>
              ...
              {selectedItem ? (
                <section className={cx("flex w-full truncate", sizes[size].textContainer)}>
                  <p className={cx("truncate font-medium text-primary", sizes[size].text)}>
                    {selectedItem?.label}
                  </p>
