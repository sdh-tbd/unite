...
import { FeaturedIcon } from "@unite/ui/components/foundations/featured-icon/featured-icon"
...
function MultiSelectFooter({
  ...
  return (
    <div
      className={cx("flex items-center justify-between border-t border-secondary p-3", className)}
    >
...
export interface MultiSelectEmptyStateProps {
  /**
...
function MultiSelectEmptyState({
...
export interface MultiSelectProps extends RefAttributes<HTMLDivElement>, CommonProps {
        ...
        <AriaDialogTrigger>
            ...
            >
              {hasSelection ? (
                <span className={cx("flex items-center", sizes[size].textContainer)}>
                  ...
                  {supportingText && (
                    <span className={cx("text-tertiary", sizes[size].text)}>{supportingText}</span>
                  )}
                </span>
              ) : (
          ...
          >
            <AriaDialog className="outline-hidden">
              ...
              {showFooter && (
                <MultiSelectFooter size={size} onReset={onReset} onSelectAll={onSelectAll} />
              )}
            </AriaDialog>
          </AriaPopover>
        </AriaDialogTrigger>
