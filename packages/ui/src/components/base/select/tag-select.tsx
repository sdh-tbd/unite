...
import { Avatar } from "@unite/ui/components/base/avatar/avatar"
import type { IconComponentType } from "@unite/ui/components/base/badges/badge-types"
import { HintText } from "@unite/ui/components/base/input/hint-text"
import { Label } from "@unite/ui/components/base/input/label"
import { Popover } from "@unite/ui/components/base/select/popover"
import {
  SelectContext,
  type SelectItemType,
  sizes,
} from "@unite/ui/components/base/select/select-shared"
import { TagCloseX } from "@unite/ui/components/base/tags/base-components/tag-close-x"
import { useResizeObserver } from "@unite/ui/hooks/use-resize-observer"
...
function InnerTagSelect({
  ...
  function handleInputMouseDown(_event: React.MouseEvent<HTMLInputElement>) {
    if (comboBoxStateContext && !comboBoxStateContext.isOpen) {
      comboBoxStateContext.open()
    }
  }

  function handleTagKeyDown(event: KeyboardEvent<HTMLButtonElement>, value: Key) {
...
export function TagSelectTagsValue({
  size = "sm",
  shortcut,
  placeholder,
  shortcutClassName,
