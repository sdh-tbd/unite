...
function DropdownPopover(props: DropdownPopoverProps) {
  return (
    <AriaPopover
...
function DropdownSeparator(props: AriaSeparatorProps) {
  return (
    <AriaSeparator
      {...props}
...
function DropdownDotsButton(props: AriaButtonProps & RefAttributes<HTMLButtonElement>) {
  return (
    <AriaButton
      {...props}
